...
function MoonSystem({
  ...
  moonSize = 3,             // target size (linked to motion)
  ringSpinSpeed = 0.8,      // target spin (linked to motion)
...
// helpers (top-level or near where you compute dynamic values)
	...
	// === Motion → Moon params ===
	const MOON_BASE = 3,  MOON_MAX = 6
	const SPIN_BASE = 0.06, SPIN_MAX = 0.6 // give yourself headroom
